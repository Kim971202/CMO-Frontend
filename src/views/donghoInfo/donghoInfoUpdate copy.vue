      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <!-- <input
              type="text"
              placeholder="면적타입을 입력하세요."
              ref="hAreaTypeInput"
              v-model.trim="hAreaType"
            /> -->
            <select v-model="hAreaType">
              <option
        ...
        <tr>
          ...
          <td>
            <!-- <input
              type="text"
              placeholder="알림설정을 입력하세요."
              ref="hnSendFlagInput"
              v-model.trim="hnSendFlag"
            /> -->
            <select v-model="hnSendFlag">
